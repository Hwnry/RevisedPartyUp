    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(PartyUp.Models.ApplicationDbContext dbContext)
        {
            ...
            var users = new List<ApplicationUser>
            {
                ...
                new ApplicationUser {UserName = "admin@example.com", Email = "admin@example.com", firstName = "Henry", lastName = "Huffman"},
                new ApplicationUser {UserName = "friend1@example.com", Email = "friend1@example.com", firstName = "Joe", lastName = "Bob"},
                new ApplicationUser {UserName = "friend2@example.com", Email = "friend2@example.com", firstName = "John", lastName = "Cena"},
                new ApplicationUser {UserName = "friend3@example.com", Email = "friend3@example.com", firstName = "Filthy", lastName = "Frank"}
